...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnum(CONDITION_INCOMBAT)
	...
	registerEnum(CONDITION_PARAM_HEALTHPERCENTGAIN)
	registerEnum(CONDITION_PARAM_HEALTHPERCENTTICKS)
	registerEnum(CONDITION_PARAM_MANAPERCENTGAIN)
	registerEnum(CONDITION_PARAM_MANAPERCENTTICKS)
	...
	// Mytheos
	registerMethod("Vocation", "getHealthPercentGainTicks", LuaScriptInterface::luaVocationGetHealthPercentGainTicks);
	registerMethod("Vocation", "getHealthPercentGainAmount", LuaScriptInterface::luaVocationGetHealthPercentGainAmount);
	...
	// Mytheos
	registerMethod("Vocation", "getManaPercentGainTicks", LuaScriptInterface::luaVocationGetManaPercentGainTicks);
	registerMethod("Vocation", "getManaPercentGainAmount", LuaScriptInterface::luaVocationGetManaPercentGainAmount);
...
// Mytheos
int LuaScriptInterface::luaVocationGetHealthPercentGainTicks(lua_State* L)
{
	// vocation:getHealthGainTicks()
	Vocation* vocation = getUserdata<Vocation>(L, 1);
	if (vocation) {
		lua_pushnumber(L, vocation->getHealthPercentGainTicks());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaVocationGetHealthPercentGainAmount(lua_State* L)
{
	// vocation:getHealthGainAmount()
	Vocation* vocation = getUserdata<Vocation>(L, 1);
	if (vocation) {
		lua_pushnumber(L, vocation->getHealthPercentGainAmount());
	}
	else {
		lua_pushnil(L);
	}
...
// Mytheos
int LuaScriptInterface::luaVocationGetManaPercentGainTicks(lua_State* L)
{
	// vocation:getManaGainTicks()
	Vocation* vocation = getUserdata<Vocation>(L, 1);
	if (vocation) {
		lua_pushnumber(L, vocation->getManaPercentGainTicks());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaVocationGetManaPercentGainAmount(lua_State* L)
{
	// vocation:getManaGainAmount()
	Vocation* vocation = getUserdata<Vocation>(L, 1);
	if (vocation) {
		lua_pushnumber(L, vocation->getManaPercentGainAmount());
	}
	else {
		lua_pushnil(L);
	}
