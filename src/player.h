...
class Player final : public Creature, public Cylinder
{
	public:
		...
		// Mytheos.
		void changeManaByPercent(int32_t manaPercentToChange);
		...
		void addInCombatTicks(bool pzlock = false);
		...
		// Mytheos
		void addDamagePoints(Creature* attacker, int32_t damagePoints) override;
