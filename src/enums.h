...
enum itemAttrTypes : uint32_t {
	...
	// Mytheos
	ITEM_ATTRIBUTE_STATSLOTONE = 1 << 23,
	ITEM_ATTRIBUTE_STATSLOTTWO = 1 << 24,
	ITEM_ATTRIBUTE_STATSLOTTHREE = 1 << 25,
	ITEM_ATTRIBUTE_STATSLOTFOUR = 1 << 26,
	ITEM_ATTRIBUTE_STATSLOTFIVE = 1 << 27,
	ITEM_ATTRIBUTE_STATSLOTSIX = 1 << 28,
	ITEM_ATTRIBUTE_ITEMLEVEL = 1 << 29,
...
enum ConditionParam_t {
	...
	// Mytheos
	CONDITION_PARAM_HEALTHPERCENTGAIN = 54,
	CONDITION_PARAM_HEALTHPERCENTTICKS = 55,
	CONDITION_PARAM_MANAPERCENTGAIN = 56,
	CONDITION_PARAM_MANAPERCENTTICKS = 57,

	//TODO Mytheos
	CONDITION_PARAM_STUNSTAGE = 58,
	CONDITION_PARAM_STUNTICKS = 59,
	CONDITION_PARAM_SILENCESTAGE = 60,
	CONDITION_PARAM_SILENCETICKS = 61,
	CONDITION_PARAM_ROOTSTAGE = 62,
	CONDITION_PARAM_ROOTTICKS = 63,
	CONDITION_PARAM_CONFUSIONSTAGE = 64,
	CONDITION_PARAM_CONFUSIONTICKS = 65,
	CONDITION_PARAM_FEARSTAGE = 66,
	CONDITION_PARAM_FEARTICKS = 67,
	CONDITION_PARAM_SLEEPSTAGE = 68,
	CONDITION_PARAM_SLEEPTICKS = 69,
	CONDITION_PARAM_BLINDSTAGE = 70,
	CONDITION_PARAM_BLINDTICKS = 71,
...
// Mytheos
enum MytheosItemsStatSlot_t {
	MYTHEOSITEMSTATSLOT_ONE = 0,
	MYTHEOSITEMSTATSLOT_TWO,
	MYTHEOSITEMSTATSLOT_THREE,
	MYTHEOSITEMSTATSLOT_FOUR,
	MYTHEOSITEMSTATSLOT_FIVE,
	MYTHEOSITEMSTATSLOT_SIXTH,

	MYTHEOSITEMSTATSLOT_FIRST = MYTHEOSITEMSTATSLOT_ONE,
	MYTHEOSITEMSTATSLOT_LAST = MYTHEOSITEMSTATSLOT_SIXTH
};
...
enum MytheosStatsPrimary_t {
	...
	MYTHEOSSTATPRIMARY_VITALITY,
	MYTHEOSSTATPRIMARY_AGILITY,
	MYTHEOSSTATPRIMARY_DEXTERITY,
	MYTHEOSSTATPRIMARY_INTELLIGENCE,
	MYTHEOSSTATPRIMARY_WISDOM,

	MYTHEOSSTATPRIMARY_FIRST = MYTHEOSSTATPRIMARY_STRENGTH,
	MYTHEOSSTATPRIMARY_LAST = MYTHEOSSTATPRIMARY_WISDOM
};

// Mytheos
enum MytheosStatsSecondary_t {
	MYTHEOSSTATSECONDARY_ATTACK,
	MYTHEOSSTATSECONDARY_ATTACKSPEED,
	MYTHEOSSTATSECONDARY_MAGICATTACK,
	MYTHEOSSTATSECONDARY_CASTSPEED,
	MYTHEOSSTATSECONDARY_CRITICALCHANCE,
	MYTHEOSSTATSECONDARY_CRITICALDAMAGE,
	MYTHEOSSTATSECONDARY_DODGE,
	MYTHEOSSTATSECONDARY_DEFENCE,
	MYTHEOSSTATSECONDARY_MAGICDEFENCE,
	MYTHEOSSTATSECONDARY_HITSTAT,

	MYTHEOSSTATSECONDARY_FIRST = MYTHEOSSTATSECONDARY_ATTACK,
	MYTHEOSSTATSECONDARY_LAST = MYTHEOSSTATSECONDARY_HITSTAT
};

enum MytheosItemRarity_t {
	MYTHEOSITEMRARITY_NORMAL = 0,
	MYTHEOSITEMRARITY_MAGIC,
	MYTHEOSITEMRARITY_RARE,
	MYTHEOSITEMRARITY_MYTHIC,
	MYTHEOSITEMRARITY_LEGENDARY,

	MYTHEOSITEMRARITY_FIRST = MYTHEOSITEMRARITY_NORMAL,
	MYTHEOSITEMRARITY_LAST = MYTHEOSITEMRARITY_LEGENDARY,
};
...
enum ConditionType_t : uint64_t {
	...
	CONDITION_INCOMBAT = 1 << 28,
	// Mytheos TODO
	CONDITION_STUN = 1 << 29,
	CONDITION_SILENCE = 1 << 30,
	CONDITION_ROOT = static_cast<uint64_t>(1) << 31,
	CONDITION_CONFUSION = static_cast<uint64_t>(1) << 32,
	CONDITION_FEAR = static_cast<uint64_t>(1) << 33,
	CONDITION_SLEEP= static_cast<uint64_t>(1) << 34,
	CONDITION_BLIND = static_cast<uint64_t>(1) << 35,
};
