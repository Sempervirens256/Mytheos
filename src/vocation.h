...
class Vocation
{
	public:
		...
		// Mytheos
		uint32_t getManaPercentTicks() const {
			return manaPercentTicks;
		}
		uint32_t getManaPercentGainTicks() const {
			return gainManaPercentTicks;
		}
		uint32_t getManaPercentGainAmount() const {
			return gainManaPercentAmount;
		}
		int32_t getManaPercentPerAttack() const {
			return manaPercentPerAttack;
		}
		...
		uint32_t getHealthPercentGainTicks() const {
			return gainHealthPercentTicks;
		}
		uint32_t getHealthPercentGainAmount() const {
			return gainHealthPercentAmount;
		}
	...
	private:
		...
		// Mytheos.
		uint32_t gainHealthPercentTicks = 1;
		uint32_t gainHealthPercentAmount = 1;
		int32_t manaPercentPerAttack = 0;

		uint32_t gainManaPercentTicks = 6;
		uint32_t gainManaPercentAmount = 1;

		uint32_t manaPercentTicks = 2;
