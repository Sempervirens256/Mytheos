...
class LuaScriptInterface
{
	...
	private:
		...
		// Mytheos
		static int luaVocationGetHealthPercentGainTicks(lua_State* L);
		static int luaVocationGetHealthPercentGainAmount(lua_State* L);
		...
		//Mytheos
		static int luaVocationGetManaPercentGainTicks(lua_State* L);
		static int luaVocationGetManaPercentGainAmount(lua_State* L);
